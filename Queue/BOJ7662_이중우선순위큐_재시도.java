...
public class BOJ7662_이중우선순위큐_재시도 {

    /**
     * <a href= "https://www.acmicpc.net/problem/7662"> 링크 </a>
     * <h1>문제</h1>
     * <p>
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < t; i++) {
            ...
            for (int j = 0; j < k; j++) {
                ...
                if (command.equals("I")) {
                    //getOrDefault : n을 가져오고, 없으면 0을 가져옴.
                    // --> n이 없다면 +1 자리에 n을 넣음
                    treeMap.put(n, treeMap.getOrDefault(n, 0) + 1);
                } else { //D인 경우
                    if (treeMap.size() == 0) {
                        continue; //tree가 비어있으면 무시
                    }
                    // n이 1이라면 lastKey(=최댓값), 아니라면 firstKey(=최솟값)
                    int temp = n == 1 ? treeMap.lastKey() : treeMap.firstKey();
